...
FEATURES = ['materjal_paksus_mm', 'toorik_laius_mm', 'toorik_pikkus_mm', 'detail_laius_mm', 'detail_pikkus_mm', 'detailide_arv', 'ketas', 'avatud_plaadid']
...
def predict_result_time(result):
    ...
    if model is None or n_rows < ML_MIN_ROWS_TO_DECIDE:
        return None
