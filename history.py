...
HISTORY_COLUMNS = [
    'kuupaev', 'materjal_paksus_mm', 'toorik_laius_mm', 'toorik_pikkus_mm',
    'detail_laius_mm', 'detail_pikkus_mm', 'detailide_arv', 'avaraadiusega_ketas',
    'ketas', 'avatud_plaadid', 'poogitud_aeg_sek', 'tegelik_aeg_sek',
    'tunnihind_eur', 'materjali_hind_m2_eur', 'kokku_kulu_eur', 'markused'
]
